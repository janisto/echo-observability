...
`github.com/janisto/echo-observability/v2` available through the
[Go module ecosystem](https://pkg.go.dev/github.com/janisto/echo-observability/v2).
...
The supported Go and Echo versions are documented in the
[README](README.md#requirements). A problem caused solely by an unsupported Go
or Echo version is outside this policy.

## Reporting a Vulnerability

Do not open a public issue for a suspected vulnerability. Use
[GitHub private vulnerability reporting](https://github.com/janisto/echo-observability/security/advisories/new)
instead.

Include enough information to reproduce and assess the report:

- the affected module, Go, and Echo versions;
...
Report vulnerabilities that exist solely in Go, Echo, Zap, or another
...
[public issue tracker](https://github.com/janisto/echo-observability/issues).
