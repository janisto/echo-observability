...
func TestBasicExamplesDemonstrateDistinctTraceContextLevels(t *testing.T) {
	for _, test := range []struct {
		name       string
		newApp     func(*zap.Logger) (*echo.Echo, error)
		wantRandom bool
	}{
		{name: "Level 1 default", newApp: newBasicApp},
		{name: "Level 2", newApp: newLevel2App, wantRandom: true},
	} {
