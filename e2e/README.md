...
message are disabled so stdout remains object-only NDJSON. Building the image
verifies packaging and integration only; it does not run the server or inspect
logs.
